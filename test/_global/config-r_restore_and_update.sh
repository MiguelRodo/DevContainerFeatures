...
# Test file for config-r feature with both restore=true and update=true
# This tests the renvvv_restore_and_update() functionality
#
# This test file is executed against a running container constructed
# from the value of 'config-r_restore_and_update' in the tests/_global/scenarios.json file.
